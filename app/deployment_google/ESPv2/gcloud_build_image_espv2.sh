...
#
# Usage example for TestOpsAI project:
#   ./gcloud_build_image_espv2.sh \
#     -s "t4u-api-esp-XXXXXXXXXX.us-central1.run.app" \
#     -c "2025-01-15r0" \
#     -p "testopsai" \
#     -g "us-central1-docker.pkg.dev/testopsai/esp2builds"
#
# Parameters:
#   -s: Service name (ESP endpoint URL)
#   -c: Config ID (from endpoints configs list)
#   -p: Project ID (testopsai)
#   -g: Artifact Registry repository (optional, defaults to gcr.io)
